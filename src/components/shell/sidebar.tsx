...
function ReferralPromo({ onNavigate }: { onNavigate?: () => void }) {
  return (
    <Link
      ...
      aria-label="Refer and earn with Trove"
    >
      <div className="nx-referral-light overflow-hidden rounded-2xl border border-indigo-200/70 bg-gradient-to-br from-white via-indigo-50/75 to-sky-50/80 p-3.5 shadow-[0_12px_28px_-16px_rgba(79,70,229,0.28)] transition duration-[var(--t-card)] group-hover:-translate-y-0.5 group-hover:border-indigo-300 group-hover:shadow-[0_16px_34px_-16px_rgba(79,70,229,0.35)]">
        <div className="flex items-start gap-2.5">
          <span className="grid size-8 shrink-0 place-items-center rounded-xl bg-gradient-to-br from-violet-600 to-indigo-500 text-[13px] font-bold text-white shadow-sm">
            $
          </span>
          <span className="min-w-0 flex-1">
            ...
            <span className="mt-0.5 block text-[13px] font-semibold leading-snug text-slate-950">
          ...
          <FiChevronRight
            size={14}
            className="mt-1 shrink-0 text-indigo-500 transition-transform group-hover:translate-x-0.5"
          />
        </div>
      </div>

      <div className="nx-referral-dark overflow-hidden rounded-2xl border border-white/10 bg-gradient-to-br from-[#171727] via-[#12131f] to-[#0e1824] p-3.5 shadow-[0_16px_36px_-16px_rgba(0,0,0,0.9)] transition duration-[var(--t-card)] group-hover:-translate-y-0.5 group-hover:border-sky-400/25">
        <div className="flex items-start gap-2.5">
          <span className="grid size-8 shrink-0 place-items-center rounded-xl bg-gradient-to-br from-fuchsia-500 via-violet-500 to-sky-400 text-[13px] font-bold text-white shadow-[0_8px_22px_-8px_rgba(99,102,241,.8)]">
            $
          </span>
          <span className="min-w-0 flex-1">
            <span className="block text-[10px] font-bold uppercase tracking-[0.14em] text-sky-300">
              Refer & earn
            </span>
            <span className="mt-0.5 block text-[13px] font-semibold leading-snug text-white">
              Share Trove · get credits
            </span>
          ...
          <FiChevronRight
            size={14}
            className="mt-1 shrink-0 text-sky-300 transition-transform group-hover:translate-x-0.5"
          />
        </div>
      </div>
    </Link>
