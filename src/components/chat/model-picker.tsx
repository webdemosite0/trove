  ...
  return (
    <div ref={wrap} className="relative shrink-0">
      ...
      >
        ...
        <span className={cn("max-w-[112px] truncate font-medium", touch ? "hidden min-[390px]:inline" : "hidden sm:inline")}>
          {active.label}
        </span>
        <FiChevronDown
          size={12}
      ...
      {open ? (
        <div
          ...
          className={cn(
            "nx-in z-[85] overflow-hidden border border-line bg-white shadow-xl dark:bg-raised",
            touch
              ? "fixed inset-x-3 bottom-3 rounded-[var(--r-card)]"
              : "absolute bottom-full left-0 mb-2 w-[330px] rounded-2xl",
          )}
        >
              ...
              return (
                ...
                >
                  ...
                  <span className="min-w-0 flex-1">
                    ...
                    <span className="mt-0.5 block truncate text-[11px] font-medium text-ink-4">{model.provider}</span>
                    <span className="mt-0.5 block text-[11.5px] leading-snug text-ink-3">{model.blurb}</span>
                  </span>
                  {checked ? (
