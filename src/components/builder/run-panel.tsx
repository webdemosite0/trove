...
import { FiCopy, FiCheck, FiTerminal } from "@/components/ui/icons";
import type { Target } from "@/lib/targets";

/**
 * Shows how to run the project when live sandbox preview is unavailable.
 * Download project is intentionally removed — use Preview / Console / Terminal.
 */
    ...
    <div className="h-full overflow-auto p-5">
      <div className="bezel mx-auto max-w-[560px] p-5">
        ...
        <p className="mt-4 text-[13.5px] leading-relaxed text-ink-3">
          Live cloud Preview needs <code className="text-ink-2">E2B_API_KEY</code>. Until then, run
          these locally or open the Console tab for the project terminal.
        </p>
